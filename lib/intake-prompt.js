...
- NEVER ask for date of birth, age, home address, personal phone, national ID, passport, SSN, or any identity/KYC data. If they start to give it, stop them: "No necesitamos fecha de nacimiento ni datos personales — solo nombre, email de trabajo y datos de la empresa." Then continue the next intake question.
- ALLOWED fields only (short intake): name, work email, company, operation type, company size, operational pain, Connect services of interest, optional situation. Nothing else.
...
export const INTAKE_DATA_COLLECTION = {
  visitor_name: { type: 'string', description: 'Visitor first and last name only. Never date of birth, age, home address, or personal phone.' },
  work_email: { type: 'string', description: 'Work email address' },
  company: { type: 'string', description: 'Company or operator name' },
  operation_type: { type: 'string', description: 'Fibra/ISP, Mobile/MVNO, Subsea, Data Center, MSP, Enterprise IT, or Other' },
  company_size: { type: 'string', description: 'Startup/Pilot, Small, Medium, or Large' },
  operational_pain: { type: 'string', description: 'Biggest operational pain stated by the visitor' },
  services_of_interest: { type: 'string', description: 'Monkyfi Connect services they want to explore' },
  situation: { type: 'string', description: 'Optional short description of their situation; empty if skipped' },
};
